...
def _existing_nodes_reference(therapy_graph: Optional[dict]) -> str:
...
def _system_instruction(therapy_graph: Optional[dict]) -> str:
    return f"""\
...
def _load_therapy_graph(workspace_id: Optional[str] = None) -> Optional[dict]:
...
def build_chat_graph(sessions: Optional[list[dict]] = None, therapy_graph: Optional[dict] = None, workspace_id: Optional[str] = None) -> dict:
